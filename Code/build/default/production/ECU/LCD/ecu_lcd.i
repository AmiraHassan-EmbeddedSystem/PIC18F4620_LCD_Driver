...
# 2 "<built-in>" 2
# 1 "ECU/LCD/ecu_lcd.c" 2
# 1 "ECU/LCD/ecu_lcd.h" 1
# 12 "ECU/LCD/ecu_lcd.h"
# 1 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h" 1
# 12 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h"
...
# 12 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECU/LCD/../../MCAL/GPIO/../mcal_std_types.h" 1
# 16 "ECU/LCD/../../MCAL/GPIO/../mcal_std_types.h"
...
# 13 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h" 2

# 1 "ECU/LCD/../../MCAL/GPIO/../mcal_std_libraries.h" 1
# 12 "ECU/LCD/../../MCAL/GPIO/../mcal_std_libraries.h"
...
# 12 "ECU/LCD/../../MCAL/GPIO/../mcal_std_libraries.h" 2
...
# 13 "ECU/LCD/../../MCAL/GPIO/../mcal_std_libraries.h" 2
# 14 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h" 2
# 33 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 12 "ECU/LCD/ecu_lcd.h" 2
# 36 "ECU/LCD/ecu_lcd.h"
typedef struct{
    pin_config_t rs;
    pin_config_t en;
    pin_config_t data[4];
...
Std_ReturnType lcd_4bit_initialize(const lcd_4bit_mode *_lcd)
{
    ...
    if(((void*)0) == _lcd){
        ...
        _delay((unsigned long)((20)*(80000000UL/4000.0)));
        ret &= lcd_4bit_send_command(_lcd, 0x38);
        _delay((unsigned long)((5)*(80000000UL/4000.0)));
        ret &= lcd_4bit_send_command(_lcd, 0x38);
        _delay((unsigned long)((150)*(80000000UL/4000000.0)));
        ret &= lcd_4bit_send_command(_lcd, 0x38);
...
{
    Std_ReturnType ret = (Std_ReturnType)1;
    if((((void*)0) == _lcd) && (((void*)0) == _chr)){
        ret = (Std_ReturnType)1;
    }
    else{
        ret &= lcd_8bit_send_command(_lcd, (0x40 + (mempos*8)) );
...
static Std_ReturnType lcd_4bit_enable_signal(const lcd_4bit_mode *_lcd)
{
    ...
    _delay((unsigned long)((5)*(80000000UL/4000000.0)));
